...
public class Proyecto_AED_2016_1 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Proyecto_AED_2016_1 frame = new Proyecto_AED_2016_1();
	...
	public Proyecto_AED_2016_1() {
		final int ANCHO = 900, ALTO = 600, DX = 8, DY = 53;

		setTitle("MN-Global \u00AE >>> Hospital Solidaridad\u00AE >>> Proyecto AED 2016 1");
		setResizable(false);
		setIconImage(new ImageIcon("imagenes/hospital.png").getImage());
